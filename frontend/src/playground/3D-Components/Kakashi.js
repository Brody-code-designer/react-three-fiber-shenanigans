...
import kakashi from "../../3D-assests/kakashi-transformed.glb"

export default function Kakashi({ ...props }) {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF(kakashi)
  const { actions } = useAnimations(animations, group)

console.log('actions kakashi', actions);
    ...
    <group ref={group} {...props} dispose={null}>
      <group rotation={[Math.PI / 2, 0, 0]} scale={0.01}>
        ...
        <skinnedMesh
          ...
          material={nodes.Hatake_Kakashi_2.material}
        ...
        <skinnedMesh
          ...
          material={nodes.Hatake_Kakashi_9.material}
...
useGLTF.preload('/kakashi-transformed.glb')
